...
namespace SGA.Controller
{
    public class TnaResultController : System.Web.Mvc.Controller
    {
        public ActionResult Index(int? id)
        {
            ...
            DataSet Topic = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetTestTopicsTna", new SqlParameter[]
			{
            ...
            if (Topic != null)
            {
                for (int i = 0; i < Topic.Tables[0].Rows.Count; i++)
                {
                    ...
                    DataSet QuestionByTopic = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetQuestionByTopicTna", new SqlParameter[]
					{
						new SqlParameter("@testId", id.Value),
            ...
            {
                Text = "Training needs analysis Result"
