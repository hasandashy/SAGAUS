...
{
    public partial class ManageNP : Page
    {
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetNATopicsAdmin");
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetQuestionsNP", new SqlParameter[]
			{
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetQuestionOptionsNP", new SqlParameter[]
			{
        ...
        protected void imgSave_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateTopicDetailNP", new SqlParameter[]
				{
        ...
        protected void imgUpdateQuestion_Click(object sender, ImageClickEventArgs e)
        {
            if (this.Page.IsValid)
            {
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateNPQuestion", new SqlParameter[]
				{
					...
					new SqlParameter("@hintWord", ""),
					new SqlParameter("@hintText", "")
				});
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            if (this.Page.IsValid)
            {
                SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateAdminNPOptions", new SqlParameter[]
				{
					...
					new SqlParameter("@optionValue", this.txtOptionMark.Value.Trim())
				});
                this.BindOptions();
        ...
        protected void dtgList_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            ...
            {
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetTopicDetailNP", new SqlParameter[]
				{
        ...
        protected void grdQuestions_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetQuestionDetailNP", new SqlParameter[]
				{
        ...
        protected void grdOptions_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetOptionDetailNP", new SqlParameter[]
				{
