...
{
    public partial class EditMPtest : Page
    {
        ...
        {
            this.rptrTopics.DataSource = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetMPTopics");
        ...
        protected void parentRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
				...
				{
					"SELECT isNull(optionId,'') from  tblMpOptions where optionId = (select replyId from tblMpQuestionReply where testId=",
					this.testId,
					" and questionId=",
					questionId,
					")"
        ...
        {
            return SqlHelper.ExecuteDataset(CommandType.Text, "select * from tblMPOptions where questionId=" + qid + " ");
        }
        ...
        {
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "spGetMPQuestions", new SqlParameter[]
			{
        ...
        protected void btnFinal_Click(object sender, System.EventArgs e)
        {
            foreach (RepeaterItem itm in this.parentRepeater.Items)
            {
                ...
                if (rdb != null)
                {
                    ...
                    SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "spUpdateMpOptions", param);
                }
            }
            this.testId = 0;
