<%@ Page  Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditSSAtest.aspx.cs" Inherits="SGA.webadmin.EditSSAtest" %>
            ...
            <table width="1280" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    EDIT Procurement Assessment TEST
                                </td>
                            </tr>
                            <tr>
                                <td>
				...
				<article id="container">
					<section class="welcome-test">
						<p class="title40 floatL">Procurement Assessment</p>
						<div class="clear"></div>
					</section>
