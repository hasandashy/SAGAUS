<%@ Page Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TestChartBA.aspx.cs" Inherits="SGA.webadmin.TestChartBA" %>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    Behavioural Assessment Report Graph
                                </td>
                            </tr>
                            <tr>
                                <td>
