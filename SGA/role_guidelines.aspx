...
<tbody>
  ...
  <tr>
    ...
    <td><div><p>Routine/tactical procurement that is of a low value and/or low risk nature. This may include:</p>
      <ul>
        ...
        <li>conducting request for quote process,</li>
  ...
  <tr>
    ...
    <td><div><p>Category management as a value drive. This may include:</p>
      <ul>
        <li>developing and implementing category management plans,</li>
        <li>market analysis and total costs analysis,</li>
  ...
  <tr>
    ...
    <td><div>Accountable for developing the organisation's procurement strategy (e.g. forward procurement planning, approval of category plans, implementation of contract management functions).</div>
      <div>Implementation and management of the procurement strategy in line with the business strategy, Government policy and priorities.</div>
      <div>Extensive stakeholder engagement (internal and external).</div></td>
  </tr>
</tbody>
</table>
</div>
