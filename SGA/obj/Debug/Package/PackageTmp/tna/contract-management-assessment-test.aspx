<%@ Page Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="contract-management-assessment-test.aspx.cs" Inherits="SGA.tna.contract_management_assessment_test" %>
					...
					<section class="color-box">
						...
						<article class="scoring-guide">
							...
							<div class="guide-box2 guide-brd">
								<p class="guide-title">Beginner</p>
								<div class="wide50">
							...
							<div class="guide-box2 guide-brd">
								<p class="guide-title">Intermediate</p>
								<div class="wide50">
