<%@ Page Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="my-results-reports-np.aspx.cs" Inherits="SGA.tna.my_results_reports_np" %>
				...
				<article id="container">
					...
					<section class="my-result-box">
						<article class="breadcrumb">
							<a href="#">Report Centre</a>&nbsp; &gt; &nbsp;<a href="#">Negotiation Profile Results</a>&nbsp; <span>&gt; &nbsp;Reports</span>
						</article>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
                                ...
                                <div class="acrd-menu">
									...
									<div class="submenu">
										<ul>
											...
											<li><a href="my-results-reports-np.aspx" class="active">&bull; Reports</a></li>
										</ul>
									</div>
								</div>
								<% } else { %>
								...
								<div class="wide640">
                                    ...
                                    <asp:Repeater id="rptSgaTest" runat="server" 
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td width="10%">
                                            <a target="_blank" href="showNPPdf.aspx?id=<%#Eval("testId") %>">
