<%@ Page  Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="my-results-bar-graph-ba.aspx.cs" Inherits="SGA.tna.my_results_bar_graph_ba" %>
<%@ Register Src="~/controls/ctrlBAGraph.ascx" TagName="baGragh" TagPrefix="sga" %>
				...
				<article id="container">
					...
					<section class="my-result-box">
						<article class="breadcrumb">
							<a href="#">Report Centre</a>&nbsp; &gt; &nbsp;<a href="#">Leadership Assessment Results</a>&nbsp; <span>&gt; &nbsp;Bar Graph</span>
						</article>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<div class="my-result-container">
							<div class="col-lft">
								...
								<div class="submenu">
										<ul>
											<li><a href="my-results-bar-graph-ba.aspx" class="active" >&bull; Bar Graph</a></li>
