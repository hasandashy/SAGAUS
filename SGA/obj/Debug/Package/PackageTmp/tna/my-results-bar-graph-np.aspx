<%@ Page  Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="my-results-bar-graph-np.aspx.cs" Inherits="SGA.tna.my_results_bar_graph_np" %>
<%@ Register Src="~/controls/ctrlNAGraph.ascx" TagName="ssaGragh" TagPrefix="sga" %>
				...
				<article id="container">
					...
					<section class="my-result-box">
						<article class="breadcrumb">
							<a href="#">Report Centre</a>&nbsp; &gt; &nbsp;<a href="#">Negotiation Profile Results</a>&nbsp; <span>&gt; &nbsp;Bar Graph</span>
						</article>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<div class="my-result-container">
							<div class="col-lft">
								...
								<div class="submenu">
										<ul>
											<li><a href="my-results-bar-graph-ssa.aspx" class="active" >&bull; Bar Graph</a></li>
                                ...
                                <div class="acrd-menu">
									...
									<div class="submenu">
										<ul>
											<li><a href="my-results-bar-graph-np.aspx" class="active">&bull; Bar Graph</a></li>
							...
							<div class="col-cnt">
								<div class="wide578">
									...
									<p>In the graph below you can see your results for each step of the process.<br />This provides a visual display of your strengths and development opportunities.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
								</div>
								<p class="txtCtr">
