<%@ Page  Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TestChartNP.aspx.cs" Inherits="SGA.webadmin.TestChartNP" %>
<%@ Register Src="~/controls/ctrlNAGraph.ascx" TagName="baGragh" TagPrefix="sga" %>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    Negotiation Profile Report Graph
                                </td>
                            </tr>
                            <tr>
                                <td>
