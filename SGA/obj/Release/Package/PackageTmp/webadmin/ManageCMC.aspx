<%@ Page Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageCMC.aspx.cs" Inherits="SGA.webadmin.ManageCMC" %>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    Category Management Challenge Assessment 
                                </td>
                            </tr>
                            <tr>
                                <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:DataGrid ID="grdOptions" runat="server" AllowPaging="false" AllowSorting="false"
                                                            AutoGenerateColumns="False" CssClass="grdMain" Width="100%" GridLines="None" OnItemDataBound="grdOptions_ItemDataBound" OnItemCommand="grdOptions_ItemCommand"
                                                            PageSize="20">
                                                            <HeaderStyle CssClass="gridHeader" />
                                                            <PagerStyle Mode="NumericPages" CssClass="pager" HorizontalAlign="Center" />
                                                            <ItemStyle CssClass="gridItem" />
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Correct Answer" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <td class="grybox">
                                                        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="tform">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="3">
                                                                    <input type="checkbox" id="chkAnswer" runat="server" />
                                                                </td>
