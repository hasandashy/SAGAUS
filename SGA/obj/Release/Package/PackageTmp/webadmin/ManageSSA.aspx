<%@ Page Language="C#" MasterPageFile="~/webadmin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageSSA.aspx.cs" Inherits="SGA.webadmin.ManageSSA" %>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0" class="panbox">
                            <tr>
                                <td class="hd26">
                                    Procurement Assessment Management
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="tabs">
                                        <ul >
                                            ...
                                            <li><a href="#tabs-3">Mange Options</a></li>
                                        </ul>
                                        <div id="tabs-1">
