<%@ Page Title="" Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="ResultsRestricted.aspx.cs" Inherits="SGA.tna.ResultsRestricted" %>
				...
				<article id="container">
					...
					<section class="color-box">
						<article class="test-info-box">
							<p class="title orange">Results Restricted</p>
							<%--<p>&nbsp;</p>
						...
						<div class="my-result-container">
							...
							<div class="col-cnt">
								<div class="wide640">
                                    ...
                                    <p class="txt28 orange mrg-bt-5">Results would be shown only on completion of the Assessment.</p>
