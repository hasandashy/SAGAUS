...
namespace SGA.tna
{
    public partial class my_results_bar_graph_ba : Page
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                ...
                if (this.Session["baTestId"] != null)
                {
                    SqlParameter[] param = new SqlParameter[]
					{
						new SqlParameter("@userId", SGACommon.LoginUserInfo.userId),
						new SqlParameter("@testId", this.Session["baTestId"].ToString())
					};
                    this.graph1.testId = System.Convert.ToInt32(this.Session["baTestId"].ToString());
                }
                else
                {
                    base.Response.Redirect("my-results-reports-ba.aspx", false);
                }
            }
        }
    }
