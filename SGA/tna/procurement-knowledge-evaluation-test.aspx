<%@ Page Title="" Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="procurement-knowledge-evaluation-test.aspx.cs" Inherits="SGA.tna.procurement_knowledge_evaluation_test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- Custom Form -->
        ...
        <script type="text/javascript" language="javascript">
            ...
            function timeOut(){
                StyleRadio();
                alert('Thank you for completing the Procurement Knowledge Evaluation.Your results have been saved and submitted.');
