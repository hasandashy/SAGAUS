                ...
                <div class="col-lft">
                    ...
                    <div id="reportDiv" runat="server">
                        <% if (isCMAResult && isCAAComplete)
                            { %>
                        <p class="title18"><span id="SpRCMA" runat="server">Contract Management Pack</span></p>
                        <div class="acrd-menu">
                            <p><a href="#" class="menuitem submenuheader">Display Results</a></p>
                            <div class="submenu">
                                <ul>
                        ...
                        <%}
                            ...
                            { %>
                        <p class="title18"><span id="SpRPR" runat="server">Procurement Assessment Pack</span></p>
                        <div class="acrd-menu">
                            <p><a href="#" class="menuitem submenuheader">Display Results</a></p>
                            <div class="submenu">
                                <ul>
