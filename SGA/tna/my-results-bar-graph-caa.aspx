<%@ Page Title="" Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="my-results-bar-graph-caa.aspx.cs" Inherits="SGA.tna.my_results_bar_graph_caa" %>

<%@ Register Src="~/controls/ctrlCAAGraph.ascx" TagName="baGragh" TagPrefix="sga" %>
    ...
    <article id="container">
        ...
        <section class="my-result-box">
            <article class="breadcrumb">
                <a href="#">Report Centre</a>&nbsp; &gt; &nbsp;<a href="#">Commercial Awareness Assessment Results</a>&nbsp; <span>&gt; &nbsp;Bar Graph</span>
            </article>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
            <div class="my-result-container">
                ...
                <div class="col-cnt">
                    <div class="wide578">
                        ...
                        <p>
                            In the graph below you can see your results for each dimension
                            <br />
                            This provides a visual display of your strengths and development opportunities.
                        </p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                    </div>
