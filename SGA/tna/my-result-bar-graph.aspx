        ...
        <section class="my-result-box">
            ...
            <div class="my-result-container">
                <div class="col-lft">
                    ...
                    <%} %>
                    <p class="title18"><span id="spSkills" runat="server">Procurement Training Needs 
                        <br />
                        Analysis</span></p>
                    <% if (isTnaResult)
                       { %>
                    ...
                    <%} %>
                    <p class="title18"><span id="spBehaviour" runat="server">Contract Management Knowledge 
                        <br />
                        Evaluation</span></p>
                    <% if (isCmkResult)
                       { %>
                    ...
                    <%} %>
                    <p class="title18"><span id="spNegotiation" runat="server">Commercial Awareness<br />
                         Assessment</span></p>
                    <% if (isCaaResult)
                       { %>
                    <div class="acrd-menu">
                    ...
                    <p class="title18"><span id="spCMA" runat="server">Contract Management
                        <br />
                        Assessment</span></p>
                    <% if (isCMAResult)
                       { %>
