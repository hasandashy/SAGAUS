<%@ Page Title="" Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="commercial-awareness-assessment-test.aspx.cs" Inherits="SGA.tna.commercial_awareness_assessment_test" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- Custom Form -->
        ...
        <script type="text/javascript" language="javascript">
            ...
            function timeOut(){
                StyleRadio();
                alert('Thank you for completing the Commercial Awareness Assessment.Your results have been saved and submitted.');
...
<!-- Content Area start -->
				<article id="container">
					<section class="welcome-test">
						<p class="title40 floatL">Commercial Awareness Assessment</p>
