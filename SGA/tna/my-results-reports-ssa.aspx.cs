...
namespace SGA.tna
{
    public partial class my_results_reports_ssa : System.Web.UI.Page
    {
        ...
        {
            SGACommon.AddPageTitle(this.Page, "Procurement Assessment Result Page", "");
        ...
        protected void rptSgaTest_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                this.Session["ssaTestId"] = e.CommandArgument;
                base.Response.Redirect("my-results-bar-graph-ssa.aspx", false);
            }
        }
        ...
        public static string EmailResultBack(string testIds)
        {
            ...
            if (strArray.Length > 0)
            {
                for (int i = 0; i < strArray.Length; i++)
                {
                    ...
                    my_results_reports_ssa obj = new my_results_reports_ssa();
