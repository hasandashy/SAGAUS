<%@ Page Title="" Language="C#" MasterPageFile="~/tnaMaster.Master" AutoEventWireup="true" CodeBehind="my-cma-reports.aspx.cs" Inherits="SGA.tna.my_cma_reports" %>
            ...
            <div class="my-result-container">
                <div class="col-lft">
                    ...
                    <% if (isCMAResult && isContractPack)
                        { %>
                    <p class="title18" runat="server" id="acrdcma">
